...
namespace AutoStop.Controllers
{
    public class TravelsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string? searchString)
        {
            ...
            {
                applicationDbContext.Where(s => s.PointSend.PointName!.Contains(searchString) || s.PointArrive.PointName!.Contains(searchString));
            }
        ...
        public IActionResult ReservationList()
        {
            var list = _context.BusyPlaces
                ...
                .Include(t => t.Traverl.PointSend).OrderBy(t => t.Traverl.PointSend.PointName)
                .Include(t => t.Traverl.PointArrive).OrderBy(t => t.Traverl.PointArrive.PointName)
                .Where(u => u.AccountId == HttpContext.User.FindFirst(ClaimTypes.NameIdentifier).Value)
                .ToList();
            return View(list);  
        }
